    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalChangePassword">Cambiar Contraseña</a></li>                
                <li>
                    <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" id="closeSesion" href="<?php echo UrlBase::urlBase; ?>/src/Core/closeSession.php">Cerrar Sesión</a></li>
            </ul>
        </li>
    </ul>
</form>
